  ...
  Future<Map<String, dynamic>?> register(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await authenticationService.login(context, user.email, user.password); // Inicia sesión automáticamente
        ...
        if (errorData.containsKey('errors')) {
          return errorData[
              'errors']; // Retornar los errores al método que llamó
        }
      }
