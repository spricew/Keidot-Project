  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Perfil del Trabajador', style: TextStyle(color: darkGreen)),
      ),
      body: FutureBuilder<ProfileWorkerDTO?>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const Center(child: Text('No se encontraron datos del trabajador.'));
          }
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildProfileInfo('Años de Experiencia', '${profile.experienceYears}'),
